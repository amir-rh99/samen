...
export class CommentsComponent implements OnInit {
  ...
  ngOnInit():void{
    ...
    this.getComments(this.content)
  }

  getComments(moduleId){
    this.commentService.getComments(moduleId, ()=>{
      this.pendingComments = this.commentService.pendingComments;
      this.commentsList = this.commentService.commentsList;
    });
  }
}
